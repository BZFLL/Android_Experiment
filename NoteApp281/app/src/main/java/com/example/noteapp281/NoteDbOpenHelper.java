...
public class NoteDbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_SQL = "create table " + TABLE_NAME_NOTE + " (id integer primary key autoincrement, title text, writer text, content text, create_time text)";
